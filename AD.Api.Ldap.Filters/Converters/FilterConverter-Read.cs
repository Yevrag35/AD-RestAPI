...
namespace AD.Api.Ldap.Converters
{
    ...
    {
        public sealed override IFilterStatement ReadJson(JsonReader reader, Type objectType, IFilterStatement existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
