...
{
    /// <summary>
    /// The <see langword="abstract"/> base class for LDAP filter statements that contain sub-statements.
    /// </summary>
    public abstract class FilterContainer : FilterStatementBase, IEnumerable<IFilterStatement>
    {
        ...
        ///     <see cref="FilterContainer"/>.
        /// </returns>
        public virtual bool Remove(IFilterStatement statement)
        {
            return !(statement is null) && this.Clauses.Remove(statement);
        }
