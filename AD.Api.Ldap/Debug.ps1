...
$ocatu = New-Object AD.Api.Ldap.Filter.PropertyEqual('objectCategory', 'person')
$and = New-object AD.Api.Ldap.Filter.And
$not = [AD.Api.Ldap.Filter.Not]::new()
$not.Statement = $pe

$or = New-Object AD.Api.Ldap.Filter.Or

$and.Statements.Add($ocu)
$and.Statements.Add($ocatu)
$and.Statements.Add($not)
