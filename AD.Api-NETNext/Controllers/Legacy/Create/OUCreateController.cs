...
namespace AD.Api.Controllers.Create
{
    ...
    public class OUCreateController : ADCreateController
    {
        private IConnectionService Connections { get; }
        private ISchemaService Schema { get; }

        public OUCreateController(IIdentityService identityService, ICreateService createService, IResultService resultService,
        ...
        [HttpPost]
        [Route("create/ou")]
        public IActionResult CreateOU(
            [FromBody] OUCreateOperationRequest request,
