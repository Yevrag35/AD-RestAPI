...
/// <summary>
/// Provides utility methods for performing integer operations, including branch-free comparison compatible with the
/// contract of <see cref="IComparable{T}.CompareTo(T)"/>.
/// </summary>
